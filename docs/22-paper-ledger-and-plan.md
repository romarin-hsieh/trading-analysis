...
> - **Student-t ν → TR-04 附錄**(2026-07-09):無條件 ν 2.5-3.0/條件 ν 4.6-6.6;99% 常態低估 ~20-25%;99.9% 數字屬外插已標注。**Ang-Hodrick-Xing-Zhang 2006 / Bali-Cakici-Whitelaw 2011 / George-Hwang 2004 / Frazzini-Pedersen 2014 → TR-23**(2026-07-09,wave-1 批次):463 檔座位全數 FAIL/FLAT——IVOL/MAX/52wH 無 IC、BAB raw 反向但 EIV-clean alpha-level ≈0;「唯一倖存=GP」強化;詳見 [TR-23](tests/TR-23-anomaly-batch.md)。
> - **docs/20 佇列全清(2026-07-09):TR-03b 亦已執行**——MP 譜(47 檔座位預測成立、463 檔 13 個訊號特徵值)、clip≈LW 平手(幽靈股稽核修正後)、BAHC PARTIAL;Marcenko-Pastur 1967 與 BBP-2017 的 vol 通道部分完成,BAHC 均值通道留翻案;見 [TR-03b](tests/TR-03b-covariance-cleaning.md)。
