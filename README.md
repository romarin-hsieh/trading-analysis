...
| Then what's the asset here? | **The method and the data moat.** 45 adversarially audited test reports, a registry where negative results are first-class, seven documented self-corrections, and a $0 data stack with two collect-forward pipelines recording what money can't buy retroactively. |
...
![Verdict map of all 45 standardized tests, grouped by mechanism type](docs/img/readme_verdict_map_en.png)
...
![45 份標準化測試，依機制類型分組的判定分布](docs/img/readme_verdict_map.png)
